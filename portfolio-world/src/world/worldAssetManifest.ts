...
export const WORLD_ASSETS = {
  ...
  exhibitionHall: {
    ...
    path: "assets/world/harbor/optimized/exhibition-hall-v01.png",
    role: "waterfront Exhibition Hall production-style candidate",
    sourceType: "generated-original",
    provenance: "generated-original",
    status: "CONCEPT",
    version: "v01",
    notes: "Frontal facade reference; locked 1× runtime export replaces only Gallery programmatic visual. Source master remains non-loaded.",
    sourceWidth: 332,
    sourceHeight: 204,
    displayWidth: 332,
    displayHeight: 204,
  ...
  academy: {
    id: "academy-v01",
    textureKey: "harbor-academy-v01",
    path: "assets/world/harbor/buildings/academy-v01.png",
    role: "Tier 1 Academy destination building",
    sourceType: "generated-original",
    provenance: "generated-original",
    status: "GAME_READY",
    version: "v01",
    notes: "Batch 01 1× export; 330×190 practical visible content; functional-base anchor.",
    sourceWidth: 338,
    sourceHeight: 198,
    displayWidth: 338,
    displayHeight: 198,
  ...
  workshop: {
    id: "workshop-v01",
    textureKey: "harbor-workshop-v01",
    path: "assets/world/harbor/buildings/workshop-v01.png",
