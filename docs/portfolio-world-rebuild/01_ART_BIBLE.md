...
1. **A harbor first, a portfolio second, a game third** — in that read order, never reversed (`00_VISUAL_BRIEF.md` §1, §9).
...
| Modular | Paving, dock/pier segments, shoreline, repeated architectural elements | Supports structure; must pass the tiling/repetition check (§9) |
...
## 9. Texture / Detail Density — Tiling and Repetition Discipline
...
## 10. Landmark Hierarchy & Wayfinding
...
## 12. Asset Family Rules (from `create-game-assets`, vendored)
...
## 13. Good References (policy: see `00_VISUAL_BRIEF.md` §7 — record what/what-not/how for every entry)

*(To be populated during production. No reference is pre-approved by this document; each must be logged with its three required fields before use.)*
...
## 15. Environment-Art Skill Review Result
...
- `references/patterns.md` — squint test, Hero/Unique/Modular/Dressing tiering, composition framing, environmental-storytelling staging, and both anti-patterns cited in §3/§9/§14 above transfer directly and are incorporated into this Art Bible.
